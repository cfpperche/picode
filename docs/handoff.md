...
3. Package config descriptors remainder (ADR-0119 accepted; C0–C5 shipped, GUI-validated; docs-site Packages page done): upstream `picode.config` proposal and workspace-scope per-agent overlays if ever requested. Plan: `docs/plans/package-config-manifest.md`.
