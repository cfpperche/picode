...
0. Desktop v2 (ADR-0120): shell-owned app bar on every window (ADR-0122, supersedes 0121) - 40px local titlebar webview + content, ChatGPT-style caption buttons; owner-visual pending. Next: Phase 3 CDP browser - docs/plans/desktop-v2.md.
