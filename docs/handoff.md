...
- **2026-08-31** — **Provider Usage V2** on `feat/provider-usage-v2`. ZAI and
  OpenCode Go API keys get Usage. Codex/Grok banked resets show in the dialog;
  Redeem confirms then `POST /usage/reset`. Grok reset row is omitted if the
