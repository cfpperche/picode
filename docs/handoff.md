...
3. Package config descriptors remainder (ADR-0119; web-search + compact shipped, GUI-validated): upstream `picode.config` proposal, docs-site entry for the Packages view, workspace-scope per-agent overlays se um dia forem pedidos. Plan: `docs/plans/package-config-manifest.md`.
