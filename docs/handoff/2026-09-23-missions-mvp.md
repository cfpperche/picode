...
Verified: pre-main-sync `make ci-scoped` passed formatting, vet, hook policy, Go tests across 27 packages, JS tests/builds and docs; the final mobile control-height correction was rebuilt.
...
Visual card: purpose clear yes; hierarchy yes; breathing room yes; odd element no; quiet empty state yes.
