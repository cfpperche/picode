...
Verified: make close and final ci-scoped passed; scratch browser QA passed on the
...
Evidence: /home/goat/picode/var/screenshots/agent-menu-consistency/ (gitignored).
