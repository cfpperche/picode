...
Verified: scoped CI and final make close passed; launch tests cover exact resume, fresh/fork exclusion, revoked/stale credentials, setup rollback and secret-free diagnostics.
...
Merge: fast-forward ready; main CI runs at integration.
