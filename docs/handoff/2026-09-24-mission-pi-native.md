...
Merge: final `make close` after the latest main sync; no deploy.

## Next up

- Owner review at the final post-sync revision, then separate owner acceptance and fast-forward.
