...
- Fetches (2026-09-13): selecting a file/tree/git/app tab still asks `/api/agents/<id>/role-state` and `/slash` — only terminal tabs are excluded (`App.jsx`), two caught 404s per selection.
