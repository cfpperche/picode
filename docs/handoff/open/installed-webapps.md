...
- [x] The two last observations closed by the owner (2026-09-18): the `(N)` title badge rendering on the tile and a webapp login surviving a shell restart are validated in use.
