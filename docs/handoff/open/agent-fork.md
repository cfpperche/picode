...
- [ ] While the source agent is working, the worktree command is typed, not run (ADR-0078's interlock), and the dialog waits up to two minutes for Enter in the git terminal.
