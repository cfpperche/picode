...
- Onboarding: a first native event is required; rows 5/9/12 of `docs/plans/communication-onboarding.md` (consent, adapter repair, child timeout) remain partial. Six native CLIs passed paired transport acceptance with correct providers and loaded adapters; see `docs/plans/communication-native-finish.md`.
