...
- Communication: mobile/non-Linux recovery, custom Codex resume args/`--`, and PTY check-to-write remain unverified; uncertain attempts never retry and deleted owners can leave setup files.
