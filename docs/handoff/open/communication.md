...
- Onboarding: initial Codex/Hermes/OpenCode and resumed Codex/Hermes need a first prompt in real validation; fresh Claude waits for a saved first conversation (`docs/plans/cli-attention-matrix.md`); row 12 (`docs/plans/communication-onboarding.md`, child timeout) remains partial. Six-CLI paired transport: `docs/plans/communication-native-finish.md`.
