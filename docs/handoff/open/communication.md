...
- Onboarding: decision rows covered; initial and resumed Codex/Hermes/OpenCode needed a first prompt in matrix validation; fresh Claude waits for a saved conversation. Six-CLI paired transport: `docs/plans/communication-native-finish.md`.
