...
- [ ] Measure real Agent History `GET /api/agent-history` latency on the owner's Windows dataset after deploy; the synthetic fixture benchmark does not establish it.
