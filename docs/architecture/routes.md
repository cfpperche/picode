...
| `#/snippets` | Snippets (ADR-0130) | host library of reusable prompts. List + search + star/archive; `#/snippets/new` and `#/snippets/<id>` editor. Kind Command is hidden until the snippet-run door. Composer `/snip:` and palette **Send snippet** expand into the focused managed agent. |
