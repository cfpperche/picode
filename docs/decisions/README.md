...
| [0050](0050-tailnet-server.md) | A PiCode you own on a tailnet server — host/public URL settings, env drop-in, verified updates, provision server checks, off-box clients (`remote.json`); `tailscale cert` by SNI deferred to B.2 | accepted (B.1), amends 0007, 0018/0020, 0043, 0049 |
