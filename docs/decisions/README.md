...
| [0059](0059-transient-rpc-burst-for-tui-replies.md) | Inbox replies to idle TUI agents borrow one exact-session RPC turn behind the unchanged terminal tab | accepted, supersedes ADR-0037's 2026-09-02 consented-switch amendment and narrows 0006 |
