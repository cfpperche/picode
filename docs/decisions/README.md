...
| [0182](0182-integration-queue.md) | The integration queue — a durable per-repository queue of integration intents, eligibility bound to the reviewed revision and expiring with it, one integration operation per repository through the existing land; any project may use it and PiCode works without it | proposed |
