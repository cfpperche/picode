...
| [0061](0061-compaction-policy-package.md) | Compaction policy as an opt-in MIT pi package (`packages/pi-compact`); overlays `/compact`; active defaults without a file | accepted |
| [0062](0062-whats-new-release-highlights.md) | Curated in-product release highlights, stamped-build auto-open, per-browser acknowledgement | accepted |
