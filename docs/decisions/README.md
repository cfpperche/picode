...
| [0098](0098-package-configuration-gui.md) | Packages with a known adapter get a config GUI that edits the extension's own files (workspace layer + agent overlay); reset is scoped, never one button | accepted, extends 0010/0028, supersedes 0033 §5 "No PiCode GUI page" |
