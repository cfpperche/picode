...
| System crontab | poll on Packages open + a slow interval. Not a machine cron. (Scoped to package updates; the Automations scheduler lives in the daemon — ADR-0044.) |
