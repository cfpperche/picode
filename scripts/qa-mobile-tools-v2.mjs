...
click('Terminal actions');ab('wait','[role="dialog"]');await capture('terminal-actions-320');ab('find','role','button','click','--name','View changes');ab('wait','.gg-file-head');result.decisions.push('Terminal actions sheet opens Changes in same terminal context');
