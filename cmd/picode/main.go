...
Usage:
  ...
  picode mission              follow an assigned mission and report evidence (JSON)
...
func serve() {
	...
	// Preparation needs the bound local address and its actual TLS mode.
