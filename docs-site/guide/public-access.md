...
release with `tmux`, `git`, Node.js 22 and npm, whose installs land in her own `~/.local` — she installs the agent CLIs she uses from Agent CLIs), her home bound in, a private user
