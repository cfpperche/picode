...
- MCP **Sign in** waits for the browser, same as Claude/Codex. One login tab. If the browser says Authorization Successful, the app finishes (or **Paste address** that tab's URL).
