...
const RuntimeNodeMajor = install.NodeMajor
...
// NodeSourceScript is install.NodeSourceScript (the container build in
// internal/provision needs the same script and cannot import this package).
func NodeSourceScript(major string) (string, error) { return install.NodeSourceScript(major) }
