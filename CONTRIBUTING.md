...
| Project state at all | `docs/handoff/<date>-<branch>.md` (≤ 25 lines) for the session, `docs/handoff/open/<topic>.md` for a durable next-up or debt — `docs/handoff.md` is generated by `make handoff` and is never edited (ADR-0123) |
