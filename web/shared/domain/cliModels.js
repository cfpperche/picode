...
export const MODEL_READERS = ["omp", "pi", "codex", "opencode", "muse", "grok", "claude-code"];
...
const MODEL_PICK_FIELDS = { codex: "model", opencode: "model", muse: "model", grok: "models.default", "claude-code": "model" };
