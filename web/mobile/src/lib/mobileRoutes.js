...
export const MORE_SECTIONS = ["pins", "snippets", "outcomes", "llama", "devices", "preferences", "settings", "system", "providers", "mcps", "packages", "notifications", "apps", "clis", "integrations", "automations"];
