import { Archive, ArchiveRestore, ArrowUp, AudioLines, Book, Bot, Check, ChevronDown, ChevronLeft, ChevronRight, CircleCheck, ClipboardPaste, Clock, Copy, Download, Ellipsis, EllipsisVertical, ExternalLink, File, FlaskConical, Folder, Folders, GitBranch, GitFork, Globe, HardDrive, Home, Image, Inbox, Info, Keyboard, LayoutGrid, List, Lock, Maximize2, MessageSquare, Mic, Minimize2, Monitor, Moon, OctagonX, Package, PanelRight, Paperclip, PenLine, Pencil, Pin, Play, Plus, QrCode, RotateCw, Search, Settings, SlidersHorizontal, Smartphone, Sparkles, Square, Sun, Terminal, Trash2, TriangleAlert, Volume2, VolumeX, X } from "lucide-react";
...
export const IconPanelRight = lucide(PanelRight, 15);
