    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content className="ws-row-menu m-settings-menu" side="bottom" align="end" sideOffset={4} collisionPadding={8}>
          ...
          <DropdownMenu.Item className="ws-row-menu-item" onSelect={() => onNewCliPrincipal ? onNewCliPrincipal(ws) : onCreate("agent", ws)}><IconAgent size={14} /> New agent</DropdownMenu.Item>
