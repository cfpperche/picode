...
test("CLI routes and old preferences reach both application managers", () => {
  for (const hash of ["#/clis", "#/clis/codex", "#/clis/codex/terminals", "#/clis/pi/sessions", "#/clis/pi/providers", "#/clis/pi/providers/custom", "#/clis/pi/providers/custom/cheap", "#/clis/pi/settings", "#/clis/pi/packages", "#/clis/pi/connectors"]) {
