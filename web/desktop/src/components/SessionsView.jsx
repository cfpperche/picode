...
export const SESSION_CLIS = ["pi", "claude-code", "codex", "grok", "hermes", "opencode"];

const CLI_FALLBACK_NAMES = { pi: "Pi", "claude-code": "Claude Code", codex: "Codex", grok: "Grok", hermes: "Hermes Agent", opencode: "OpenCode" };
