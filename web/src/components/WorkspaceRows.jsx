...
export function AgentRow({
  ...
  const working = !waiting && (bursting || ag.streaming || ag.id === workingId || (workingIds || []).includes(ag.id));
      ...
      <div className="ws-row-main">
        ...
        {actions ? (
          <RowMenu label={label}>
            ...
            {!ag.burst ? <RowMenuItem onSelect={() => onChat && onChat(ag.id)}><IconChat size={14} /> Open chat</RowMenuItem> : null}
