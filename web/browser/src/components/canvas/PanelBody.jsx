...
export default function PanelBody({ model, loaded, body = "live", hidden, focused, onOpen, onRemove, onRun, onOpenFile, attach, onAttachClose, onPasteFiles, find, onFindClose, onDirty, onSaveText }) {
  switch (model.state) {
