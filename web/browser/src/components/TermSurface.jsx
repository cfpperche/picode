...
export default function TermSurface({ adopt = "", term, error, hidden, autoFocus = true, onOpenFile, onOpenLink, cwdKind, tabId, attach, onAttachClose, onPasteFiles, promptDoor, find, onFindClose }) {
