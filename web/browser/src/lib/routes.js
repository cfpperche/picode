...
export function parseRoute(hash) {
  ...
  if (h === "/clis" || h.startsWith("/clis/")) return "clis";
...
// Terminal appearance lives on the terminal settings page (#/termset); an
// unknown section falls back to Appearance.
const PREF_SECTIONS = ["appearance", "shortcuts", "notifications", "landing", "server", "backup"];
